...
public class LGS_ReservationCtrl {
	...
	//
	private final String VIEW_MAIN ="reservation/reservation_main";
	...
	@RequestMapping(value = "reservation/main.do", method = RequestMethod.GET)
	public String main() {
		LOG.debug("==================================");
		LOG.debug("Controller : reservation/main.do");
		LOG.debug("==================================");
