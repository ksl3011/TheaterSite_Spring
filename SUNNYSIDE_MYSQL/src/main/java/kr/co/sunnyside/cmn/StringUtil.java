...
public class StringUtil {
	...
	// File Root 디렉토리
	//public static final String UPLOAD_ROOT = "/usr/local/apache-tomcat-8.5.34/webapps/SUNNYSIDE3/resources/image"; 
	//public static final String MAIN_IMAGE_ROOT = "/usr/local/apache-tomcat-8.5.34/webapps/SUNNYSIDE3/resources/img/banner";
	public static final String UPLOAD_ROOT = "/usr/local/src/apache-tomcat-8.5.47/webapps/SUNNYSIDE_MYSQL/resources/image"; //aws 사용했을 때 상품사진 저장 위치
	public static final String MAIN_IMAGE_ROOT = "/usr/local/src/apache-tomcat-8.5.47/webapps/SUNNYSIDE_MYSQL/resources/img/banner";
...
//	public static final String MAIN_IMAGE_ROOT = "C:\\Users\\sist\\git\\SUNNYSIDE3\\SUNNYSIDE3\\src\\main\\webapp\\resources\\img\\banner";
	...
	public static String changePath(String str) {
		String tmp = File.separator + "resources";
