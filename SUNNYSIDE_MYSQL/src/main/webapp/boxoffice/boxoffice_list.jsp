...
<body>
	...
	<div class="page-header">
		<!-- 박스오피스 -->
		<h1><spring:message code="message.movie.boxoffice"/></h1>
					...
					<article class="mix mix_all" style="display: inline-block; opacity: 1; width:250px; height:500px;">
						...
						<div class="image_holder" >		
							...
							<span class="text_holder"><span class="text_outer"><span class="text_inner" ><span class="feature_holder" ><span class="feature_holder_icons">
								<!-- 예매하기 -->
								<a class="lightbox qbutton small white" href="#" onclick="javascript:reservationPage('${context}', '<c:out value='${vo.movieId}'/>');"><spring:message code="message.movie.ticketing"/></a>
								<!-- 상세보기 -->
